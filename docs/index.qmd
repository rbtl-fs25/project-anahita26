...
data_clean <- data %>%
  mutate(across(c(new_items, env_conscious), as.numeric))

# Select variables to summarize
summary_data <- data_clean %>%
  summarise(
    `New Items - Mean` = mean(new_items, na.rm = TRUE),
    `New Items - Median` = median(new_items, na.rm = TRUE),
    `New Items - SD` = sd(new_items, na.rm = TRUE),
    `New Items - Min` = min(new_items, na.rm = TRUE),
    `New Items - Max` = max(new_items, na.rm = TRUE),
    
    `Env Conscious - Mean` = mean(env_conscious, na.rm = TRUE),
    `Env Conscious - Median` = median(env_conscious, na.rm = TRUE),
    `Env Conscious - SD` = sd(env_conscious, na.rm = TRUE),
    `Env Conscious - Min` = min(env_conscious, na.rm = TRUE),
    `Env Conscious - Max` = max(env_conscious, na.rm = TRUE)
  ) %>%
